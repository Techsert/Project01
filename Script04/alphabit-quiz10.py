...
class AlphabitQuiz:
    def __init__(self):
        ...
        self.intro_delay = 2000        # 2 seconds before showing difficulty icons
...
##        self.state = "menu"  # menu, playing, feedback, results
    ...
    def play_current_question_sound(self):
        ...
        if s:
            ...
            if self.bg_music_path:
                ...
                pygame.mixer.music.set_volume(max(0, oldv * 0.25))
                pygame.time.set_timer(pygame.USEREVENT+2, 1400, True)
            self.play_sfx(s)
    ...
    def draw(self):
        ...
        if self.state == "intro":
            ...
            title_surf = render_arabic_to_surface("ما هذا؟ 🧠", ARABIC_FONT_PATH or "", 64, color=(255,255,255))
