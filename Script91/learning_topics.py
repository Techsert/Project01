...
# ============================================================
# Learning Level 1 - Alphabet names
# ============================================================
def topic_one(screen, main_app):
    ...
    topics_data = [
        ...
        ("", main_app.launch_quiz_lvl1, "hover_quiz.ogg", "Q_lvl1.png", "Q1"),                # Quiz One
    ]
...
def topic_two(screen, main_app):
    ...
    topics_data = [
        ...
        ("", main_app.launch_quiz_lvl2, "hover_quiz.ogg", "Q_lvl2.png", "Q2"),               # Quiz
    ]
...
# ============================================================
# Learning Level 3 - Kas-Rah
# ============================================================
def topic_three(screen, main_app):
    SCREEN_WIDTH, SCREEN_HEIGHT = screen.get_size()
    bg_path = os.path.join(config.IMG_MAIN_PATH, "bg-tr.png")
    ...
    positions = [
        (0.82, 0.50), # Kas-Rah
        (0.50, 0.50),  # P_lvl3_P1
        (0.18, 0.50),  # Quiz Three
    ]


    topics_data = [
        ("", main_app.launch_learn_lvl3_T1, "hover_KAS-RA.ogg", "T_lvl2_T3.png", "T1"),        # Kas-Rah
        ("", main_app.launch_practice_lvl3_P1, "hover_practice.ogg", "T_lvl1_T4.png", "P1"),            # Practice
        ("", main_app.launch_quiz_lvl3, "hover_quiz01.ogg", "Q_lvl3.png", "Q3"),               # Quiz
    ]
    ...
    draw_topic_screen(screen, main_app, "Learning Level 3", buttons, bg_image, bg_rect, level=3)

# ============================================================
# Learning Level 4 - Dam-Mah
# ============================================================
def topic_four(screen, main_app):
    SCREEN_WIDTH, SCREEN_HEIGHT = screen.get_size()
    bg_path = os.path.join(config.IMG_MAIN_PATH, "bg-tr.png")
    ...
    positions = [
        (0.82, 0.50), # Dam-Mah
        (0.50, 0.50),  # Practice lvl4_P1
        (0.18, 0.50),  # Quiz Four
    ]


    topics_data = [
        ("", main_app.launch_learn_lvl4_T1, "hover_DA-MA.ogg", "T_lvl2_T4.png", "T1"),        # DAM-MAH
        ("", main_app.launch_practice_lvl4_P1, "hover_practice.ogg", "T_lvl1_T4.png", "P1"),            # Practice
        ("", main_app.launch_quiz_lvl4, "hover_quiz.ogg", "Q_lvl4.png", "Q4"),               # Quiz
...
##        ("", main_app.launch_learn_lvl2_T7, "hover_Lvl1_Topic3_ogg.ogg", "T_lvl2_T7.png", "T3"),        # Revision
    ...
    draw_topic_screen(screen, main_app, "Learning Level 4", buttons, bg_image, bg_rect, level=4)
