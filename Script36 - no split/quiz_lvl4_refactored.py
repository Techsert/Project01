# quiz_lvl4_refactored.py - OPTIMIZED VERSION
# Uses optimized QuizPlayer base class with threaded loading
...
def run_quiz_lvl4(screen, main_app):
    """
    Launch numbers quiz (level 4) with optimized loading.
    
    Args:
        screen: Pygame screen surface
        main_app: Reference to main QuizApp
    """
    print("🎮 [RUNNING] quiz_lvl4")
