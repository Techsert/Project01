# main_menu28.py - FIXED VERSION with AudioManager
import os
import sys
import pygame
...
from quiz_lvl1_3_refactored import run_quiz_lvl1_3
from quiz_lvl4_refactored import run_quiz_lvl4
from audio_manager import AudioManager  # ✅ ADDED
...
class MainApplication:
    def __init__(self, selected_profile):
        ...
        # ✅ REMOVED: Old audio code replaced with AudioManager
        ...
        # Backwards compatibility attributes (used by other modules)
    ...
    # ==========================================================
    # AUDIO METHODS (✅ Updated to use AudioManager)
    # ==========================================================
    ...
    def open_profile_manager(self):
        ...
        # ✅ FIX: Push context BEFORE any audio operations
        print("👤 Opening profile manager...")
        self.audio_manager.push_audio_context()
        
        # Now stop sounds (context is already saved)
        self.audio_manager.stop_all_sounds()
        ...
        # ✅ Restore previous audio context
        print("👤 Profile manager closed, restoring audio...")
...
##        self.audio_manager.stop_all_sounds()
    ...
    def launch_quiz_lvl1_3_with_difficulty(self, difficulty):
        """Launch Quiz Levels 1-3 with pre-selected difficulty."""
##        self.audio_manager.stop_all_sounds()
        run_quiz_lvl1_3(self.screen, self, auto_difficulty=difficulty)

##    def launch_quiz_lvl1_3(self):
##        """Launch Quiz Levels 1-3 (Alphabet)."""
##        self.audio_manager.stop_all_sounds()
##        run_quiz_lvl1_3(self.screen, self, level=self.level)

    def launch_quiz_lvl4(self):
        """Launch Quiz Level 4 (Numbers)."""
##        self.audio_manager.stop_all_sounds()
...
if __name__ == "__main__":
    ...
    app = MainApplication(selected_profile)
    app.run()
