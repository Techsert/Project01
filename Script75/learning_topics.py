...
def topic_one(screen, main_app):
    ...
    btn_w, btn_h = int(bg_w * 0.18), int(bg_h * 0.38)
    
    positions = [
        (0.78, 0.35), # Introduction
        (0.59, 0.63), # Alphabet Names
        (0.40, 0.35),  # Revision
        (0.21, 0.63),  # P1 - bottom right
    ]
    ...
    topics_data = [
        ...
        ("", main_app.launch_practice_lvl1_P1, "hover_Lvl1_Topic3_ogg.ogg", "T_lvl1_T4.png"),  # ✅ Practice 1
    ]
