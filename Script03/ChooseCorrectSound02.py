...
class WhatIsThis:
    ...
    def show_feedback(self, is_correct=True):
        ...
        # Function to close popup and move to next question
        ...
        # Bind click on image to close immediately
...
##            self.show_final_result()
    ...
    def show_final_result(self):
        ...
        score_msg = f"أحسنت! نتيجتك: {self.score} من {len(QUESTIONS)}"
        lbl = tk.Label(popup, text=score_msg, font=("Arial", 28, "bold"), bg="#e6ffe6")
