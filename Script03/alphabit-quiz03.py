...
class WhatIsThis:
    ...
    def show_welcome_screen(self):
        ...
        img_path = os.path.join(IMG_PATH, "welcome.png")
        try:
            ...
            print("⚠️ Missing welcome image:", img_path)

        # Difficulty selector
        tk.Label(frame, text="اختر المستوى:", font=("Arial", 24, "bold"), bg="white").pack(pady=10)
        self.difficulty_var = tk.StringVar(value="easy")
        difficulty_menu = tk.OptionMenu(frame, self.difficulty_var, "easy", "medium", "hard")
        difficulty_menu.config(font=("Arial", 20), bg="#e2e3e5")
        difficulty_menu.pack(pady=10)

        # Start button
        start_btn = tk.Button(frame, text="ابدأ اللعب 🎮", font=("Arial", 28, "bold"),
                              bg="#d4edda", command=self.start_game)
        start_btn.pack(pady=40)

        # Optional sound
        self.play_sound("welcome.wav", "feedback")
    ...
    def start_game(self):
        ...
        # Now it’s safe to show the first question
        self.show_question()
