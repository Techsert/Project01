...
##            print("⚠️ Missing welcome image:", img_path)
        ...
        self.difficulty_photos = {}  # keep references to PhotoImages
        ...
        for level in difficulties:
            ...
            try:
                img = Image.open(img_path).resize((411, 688))
                photo = ImageTk.PhotoImage(img)
                self.difficulty_photos[level] = photo  # keep reference
                ...
                btn = tk.Button(
                    ...
                    bg="white",         # background behind image
                    activebackground="white",
                    relief="flat",      # flat style
                    command=lambda lvl=level: self.select_difficulty(lvl)
                )
