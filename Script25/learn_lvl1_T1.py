...
slides = [
    # intro slide
    {
        ...
        "video": {
            ...
            "audio_path": "../assets/sounds/Learn_lvl1_T1/lvl1_topic1_Slid1.wav",
    ...
    # Sub intro slide 
    {
        ...
        "video": {
            "path": "../assets/videos/lvl1_topic1_Slid2_fixed02.mp4",
            "audio_path": "../assets/sounds/Learn_lvl1_T1/lvl1_topic1_Slid2.wav",
            "scale": (0.3, 0.5), 
            "position": "center"
        },
         "images": [
...
def run_learn_lvl1_T1(screen, main_app):
    ...
    while running:
            ...
            if e.type == pygame.QUIT:
                ...
                if main_app.exit_rect.collidepoint(e.pos):
                    ...
                    if not is_video_playing:
                        ...
                        start_time = time.time() # Reset for image delays
                        ...
                        # Video will re-initialize in render_slide for "video" slides
        ...
        clock.tick(30) # Maintain a consistent frame rate for Pygame display
