...
from profile_screen10 import run_profile_screen, run_profile_manage_screen
    ...
    def run(self):
        while self.running:
            ...
            if self.show_welcome:
                if self.welcome_bg: screen.blit(self.welcome_bg, self.welcome_bg_pos)
                self.draw_arabic_text("مرحباً", 0.12, (51, 51, 51), (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3), bold=True)
