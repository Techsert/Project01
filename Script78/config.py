...
# ✅ Icon paths
ICONS_PATH = os.path.join(IMG_MAIN_PATH, "icons")
...
PERFECT_ICON_PATH = os.path.join(ICONS_PATH, "perfect_icon.png")
PARTY_ICON_PATH = os.path.join(ICONS_PATH, "party_icon.png")
DIAMOND_ICON_PATH = os.path.join(ICONS_PATH, "diamond_icon.png")
TRY_AGAIN_ICON_PATH = os.path.join(ICONS_PATH, "tryagain_icon.png")
