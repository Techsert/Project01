    ...
    def render_slide(self, slide):
        ...
        if "images" in slide:
            ...
            for img_data in slide["images"]:
                ...
                flash_count = img_data.get("flash_count", 0)  # Number of flashes (0 = no flash)
                ...
                if elapsed >= delay and (duration is None or elapsed <= delay + duration):
                    ...
                    # ✅ NEW: Apply flashing effect
                    should_draw = True
                    if flash_count > 0:
                        # Initialize flash state if not exists
                        if "_flash_start" not in img_data:
                        ...
                        # else: flash complete, stay visible
                ...
                # Play sound if specified (existing code - keep as is)
