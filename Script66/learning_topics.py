...
def topic_two(screen, main_app):
    ...
    topics_data = [
        ("Introduction", main_app.launch_learn_lvl2_T1, "hover_Lvl1_Topic1_ogg.ogg", "f04.png"),
        ("Alphabet Sounds", main_app.launch_learn_lvl2_T2, "hover_Lvl2_Topic2.ogg", "f05.png"),
