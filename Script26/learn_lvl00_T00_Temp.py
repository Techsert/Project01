# learn_lvl00_T00_Temp — Full Pygame version (Arabic-friendly, with profile integration)
...
slides = [
        # Intro Slide
    {
        "title": "الحُروف العَرَبية TEMP PY File",
...
# RUN FUNCTION
# ==========================================================
def run_alphabit_name(screen, main_app):
