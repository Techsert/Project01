...
class QuizApp:
    ...
    def launch_alphabit_name(self):
        ...
        def delayed_launch():
            ...
            run_alphabit_name(self.root)  # reuse same root
    ...
    def launch_alphabit_sound(self):
        ...
        def delayed_launch():
            ...
            run_alphabit_sound(self.root)  # reuse same root
    ...
    def show_section_screen(self):
        ...
        button_specs = [
            (0.15, 0.36, "أسماء الحُروف", self.launch_alphabit_name, "assets/sounds/main/hover_alphabet.mp3"),
            (0.50, 0.36, "أصوات الحُروف", self.launch_alphabit_sound, "assets/sounds/main/hover_numbers.mp3"),
