...
from learn_lvl3_T1 import run_learn_lvl3_T1
from learn_lvl4_T1 import run_learn_lvl4_T1

# -------------- Practices ----------------------
from practice_lvl1_P1 import run_practice_lvl1_P1
from practice_lvl2_P1 import run_practice_lvl2_P1
from practice_lvl3_P1 import run_practice_lvl3_P1
from practice_lvl4_P1 import run_practice_lvl4_P1
...
from quiz_lvl4 import run_quiz_lvl4
...
class QuizApp:
    ...
    def launch_learn_lvl3_T1(self):
        """Launch Level 3 Topic 1."""
        self.audio_manager.stop_all_sounds()
        run_learn_lvl3_T1(self.screen, self)
        self._reload_profile()
    ...
    def launch_practice_lvl3_P1(self):
        """Launch Level 3 Practice 1."""
        self.audio_manager.stop_all_sounds()
        run_practice_lvl3_P1(self.screen, self)
        self._reload_profile()
    ...
    def open_welcome_screen(self):
        ...
        extra_buttons = [
            ...
            {"label": "Alphabet", "color": (255, 204, 0), "x_ratio": 0.39, "y_ratio": 0.45, "w_ratio": 0.15, "h_ratio": 0.10},
