...
class QuizGameBase:
    ...
    def _load_feedback_icons(self):
        ...
        self.perfect_icon = load_feedback_icon(
    ...
    def draw_menu(self):
        ...
        title_surf = render_arabic_to_surface("Let's Play", BOLD_ARABIC_FONT, 80, color=(0, 0, 0), bold=True, italic=True)
    ...
    def draw_playing(self):
        ...
        if self._last_progress_idx != current:
            ...
            self._cached_progress_text = render_arabic_to_surface(
                counter_text, ARABIC_FONT_PATH, 60, color=(20, 120, 20)
            )
    ...
    def draw_results(self):
        ...
        # Draw title
        title = render_arabic_to_surface("Quiz Result", ARABIC_FONT_PATH or "", 64, color=(255,255,255), bold=True)
