...
class PracticeBase:
    ...
    def check_answer(self, idx):
        ...
        # Check if correct
        self.feedback_correct = (idx == correct_answer)
        
        # Get feedback assets
        self.current_feedback_img = self._get_feedback_image(self.feedback_correct)
        snd = self._get_feedback_sound(self.feedback_correct)
