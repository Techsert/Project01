...
def topic_one(screen, main_app):
    ...
    positions = [
        ...
        (0.65, 0.70),  # P1 - bottom right
        (0.35, 0.70),  # P2 - bottom left
    ]
    ...
    topics_data = [
        ...
        ("L1P1", main_app.launch_practice_lvl1_P1, "hover_Lvl1_Topic3_ogg.ogg", "T_lvl1_T3.png"),  # ✅ Practice 1
        ("L1P2", main_app.launch_practice_lvl1_P2, "hover_Lvl1_Topic3_ogg.ogg", "T_lvl1_T3.png"),  # ✅ Practice 2
    ]
...
def topic_two(screen, main_app):
    ...
    positions = [
        ...
        (0.285, 0.67),
        (0.50, 0.67),
        (0.65, 0.75),  # P1 - bottom right
        (0.35, 0.75),  # P2 - bottom left
    ]
    ...
    topics_data = [
        ...
        ("L2P1", main_app.launch_practice_lvl2_P1, "hover_Lvl1_Topic3_ogg.ogg", "T_lvl2_T7.png"),  # ✅ Practice 1
        ("L2P2", main_app.launch_practice_lvl2_P2, "hover_Lvl1_Topic3_ogg.ogg", "T_lvl2_T7.png"),  # ✅ Practice 2
    ]
