...
class QuizApp:
    ...
    def create_profile_screen(self):
        """Inline profile creation with name and PIN entry."""
        ...
        # Input boxes
        name_rect = pygame.Rect(SCREEN_WIDTH//2 - 200, SCREEN_HEIGHT//3, 400, 80)
        ...
        running_creation = True
        while running_creation:
            screen.fill((255,255,255))
            ...
            display_name = name_text if name_text or input_active else "أدخل الاسم هنا"
            self.draw_arabic_text(display_name, 50, (0,0,0), name_rect.center)

            # Draw PIN input box
            pygame.draw.rect(screen, (200,200,200), pin_rect)
            masked_pin = "*"*len(pin_text) if pin_text or input_active else "أدخل الرقم السري"
            self.draw_arabic_text(masked_pin, 50, (0,0,0), pin_rect.center)
