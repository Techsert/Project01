...
def run_profile_screen(screen, SCREEN_WIDTH, SCREEN_HEIGHT):
    ...
    def draw_profiles():
        ...
        draw_arabic_text(screen, "Select Your Profile", ARABIC_BOLD_FONT_PATH, 48, (0, 0, 0),
        ...
        draw_arabic_text(screen, "New Profile", ARABIC_BOLD_FONT_PATH, 36, (255, 255, 255),
                         create_button.center, bold=True)

    def draw_create_form():
        screen.fill((245, 245, 245))
        draw_arabic_text(screen, "Creat New File", ARABIC_BOLD_FONT_PATH, 48, (0, 0, 0),
                         (SCREEN_WIDTH // 2, 60), align="center")

        font = pygame.font.Font(ARABIC_FONT_PATH, 36)

        # ===================== Name Field =====================
        draw_arabic_text(screen, "Name:", ARABIC_BOLD_FONT_PATH, 36, (0, 0, 0),
                         (name_rect.centerx - 200, name_rect.centery), align="center")
        ...
        while font.size(name_text)[0] > name_rect.width - 20:  # keep 10px margin
            name_text = name_text[1:]  # remove first character if too long
        ...
        if active_input == "name" and cursor_visible:
            ...
            pygame.draw.line(screen, (0, 0, 0),
                             (cursor_x, cursor_y_top), (cursor_x, cursor_y_bottom), 2)

        # ===================== Age Field =====================
        draw_arabic_text(screen, "Age", ARABIC_BOLD_FONT_PATH, 36, (0, 0, 0),
                         (age_rect.centerx - 200, age_rect.centery), align="center")
        ...
        # ===================== Avatar Selection =====================
        draw_arabic_text(screen, "Choose your avatar", ARABIC_BOLD_FONT_PATH, 48, (0, 0, 0),
        ...
        # ===================== Save Button =====================
        pygame.draw.rect(screen, (255, 102, 0), create_button, border_radius=15)
        draw_arabic_text(screen, "Save", ARABIC_BOLD_FONT_PATH, 36, (255, 255, 255),
                         create_button.center, bold=True)
    ...
    while True:
        ...
        if cursor_timer >= 500:  # blink every 0.5s
