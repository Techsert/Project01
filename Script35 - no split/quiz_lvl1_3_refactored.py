# quiz_lvl1_3_refactored.py
# Refactored to match learning module pattern
import os
import pygame
...
def run_quiz_lvl1_3(screen, main_app, auto_difficulty=None):
    """
    Launch alphabet quiz (levels 1-3).
    
    Args:
        screen: Pygame screen surface
        main_app: Reference to main QuizApp
        auto_difficulty: Optional - auto-select difficulty ("easy", "medium", "hard")
                        If None, user selects from menu
    """
    print(f"[RUNNING] quiz_lvl1_3_refactored with auto_difficulty={auto_difficulty}")
    ...
    player = AlphabetQuizPlayer(
        ...
        main_app=main_app,
        questions=QUESTIONS,
        level=1,  # For navigation back to learning topics
