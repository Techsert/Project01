...
##
##        back_font = dynamic_font(SCREEN_HEIGHT, config.ARABIC_FONT_REGULAR, config.ARABIC_FONT_BOLD, 0.03, bold=True)
...
##        ("Introduction", main_app.launch_learn_lvl1_T1, "hover_Lvl1_Topic1_ogg.ogg", "f01.png"),
        ("Alphabet Names- Easy", lambda: main_app.launch_quiz_lvl1_3_with_difficulty("easy"), "hover_Lvl1_Topic2_ogg.ogg", "LVL 1.png"),
...
##        ("Introduction LVL2", main_app.launch_learn_lvl2_T1, "hover_Lvl1_Topic1_ogg.ogg", "f04.png"),
        ("Alphabet Sounds\nMeduim", lambda: main_app.launch_quiz_lvl1_3_with_difficulty("medium"), "hover_Lvl1_Topic2_ogg.ogg", "Lvl 2.png"),
...
##        (0.80, 0.60)  # Mid-rightish
    ...
    topics_data = [
##        ("Introduction LVL2", main_app.launch_learn_lvl2_T1, "hover_Lvl1_Topic1_ogg.ogg", "f04.png"),
        ("Alphabet Shapes\n(Hard)", lambda: main_app.launch_quiz_lvl1_3_with_difficulty("hard"), "hover_Lvl1_Topic2_ogg.ogg", "Lvl 3.png"),
##        ("LVL 2\n Revision", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f06.png"),
##        ("الأعداد", main_app.launch_alphabit_sound, "hover_numbers.wav", "b4.png"),
##        ("الألوان", main_app.launch_alphabit_sound, "hover_colours.wav", "b5.png"),
##        ("الكَلِمات", main_app.launch_alphabit_sound, "hover_words.wav", "b6.png"),
...
# Quiz Level 4 
# ============================================================
def quiz_four(screen, main_app):
    """Quiz Topics for Level 4"""
    SCREEN_WIDTH, SCREEN_HEIGHT = screen.get_size()  # Get from existing screen
    bg_path = os.path.join(config.IMG_MAIN_PATH, "bg-tr.png")
...
##        (0.80, 0.60)  # Mid-rightish
    ...
    topics_data = [
##        ("Introduction LVL2", main_app.launch_learn_lvl2_T1, "hover_Lvl1_Topic1_ogg.ogg", "f04.png"),
        ("Numbers", main_app.launch_quiz_lvl4, "hover_Lvl1_Topic2_ogg.ogg", "Lvl 4.png"),
##        ("LVL 2\n Revision", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f06.png"),
##        ("الأعداد", main_app.launch_alphabit_sound, "hover_numbers.wav", "b4.png"),
##        ("الألوان", main_app.launch_alphabit_sound, "hover_colours.wav", "b5.png"),
##        ("الكَلِمات", main_app.launch_alphabit_sound, "hover_words.wav", "b6.png"),
    ...
    draw_quiz_screen(screen, main_app, "Quiz Level 4", buttons, bg_image, bg_rect)
# ============================================================
# Dispatcher Function
# ============================================================
