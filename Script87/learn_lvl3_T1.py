...
# RUN FUNCTION
# ==========================================================
def run_learn_lvl3_T1(screen, main_app):
    """Launch Topic 3."""
    ...
    if profile_name:
        mark_learning_topic_complete(profile_name, 3, "T1")
        print(f"✅ Completed Learning Level 3 - Topic T1")
