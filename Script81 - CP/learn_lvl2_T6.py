...
# RUN FUNCTION
# ==========================================================
def run_learn_lvl2_T6(screen, main_app):
    """Launch Topic 6."""
    ...
    player.topic = "T6"  # ✅ SET TOPIC IDENTIFIER
    ...
    if profile_name:
        mark_learning_topic_complete(profile_name, 2, "T6")
        print(f"✅ Completed Learning Level 2 - Topic T6")
