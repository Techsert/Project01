...
# RUN FUNCTION
# ==========================================================
def run_learn_lvl2_T7(screen, main_app):
    """Launch Topic 7."""
    ...
    player.topic = "T7"  # ✅ SET TOPIC IDENTIFIER
    ...
    if profile_name:
        mark_learning_topic_complete(profile_name, 2, "T7")
        print(f"✅ Completed Learning Level 2 - Topic T7")
