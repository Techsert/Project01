...
def topic_two(screen, main_app):
    ...
    topics_data = [
        ("Introduction", main_app.launch_learn_lvl2_T1, "hover_Lvl1_Topic1_ogg.ogg", "f01.png"),
        ("FAT-HA", main_app.launch_learn_lvl2_T2, "hover_Lvl2_Topic2.ogg", "f02.png"),
        ("KASRA", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f03.png"),
        ("DAMA", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f04.png"),
        ("TAN-WEEN", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f05.png"),
        ("SOKON", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f06.png"),
        ("Revision", main_app.launch_learn_lvl2_T3, "hover_Lvl1_Topic3_ogg.ogg", "f01.png"),
    ]
