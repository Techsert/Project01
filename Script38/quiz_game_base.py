...
class QuizGameBase:
    ...
    def __init__(self, level=1, difficulty="easy"):
        ...
        Args:
            level: Quiz level number (1, 2, 3)
            difficulty: Difficulty name for button image ("easy", "medium", "hard")
        """
        pygame.init()
        pygame.mixer.init()
    ...
    def _load_feedback_assets(self):
        ...
        self.correct_feedback_imgs = [
            load_image(os.path.join(IMG_PATH, f"thumbsup{i if i else ''}.png"))
            for i in ['', '1', '2', '3', '4', '5', '6']
        ]
        
        self.wrong_feedback_imgs = [
            load_image(os.path.join(IMG_PATH, f"thumbsdown{i if i else ''}.png"))
            for i in ['', '1', '2', '3', '4', '5', '6']
        ]
        
        self.correct_feedback_sounds = [
            load_sound(os.path.join(SOUND_PATH, f"correct{i if i else ''}.wav"))
            for i in ['', '1', '2', '3', '4', '5']
        ]
        
        self.wrong_feedback_sounds = [
            load_sound(os.path.join(SOUND_PATH, f"wrong{i if i else ''}.wav"))
            for i in ['', '1', '2', '3', '4', '5']
        ]
    ...
    def handle_exit_hover(self):
        """Handle exit button hover sound"""
        mouse_pos = pygame.mouse.get_pos()
