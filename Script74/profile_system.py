...
# ==========================================================
LEARNING_STRUCTURE = {
    1: ["T1", "T2", "T3", "T4", "T5"],  # Level 1 has 3 topics
    2: ["T1", "T2", "T3", "T4", "T5", "T6", "T7", "T8", "T9"],  # Level 2 has 3 topics
...
def get_unlock_status(profile_name):
    ...
    if not profile_name:
        return {
            "learning": {
                1: {"T1": True, "T2": False, "T3": False, "T4": False, "T5": False},
                2: {"T1": False, "T2": False, "T3": False, "T4": False, "T5": False, "T6": False, "T7": False, "T8": False, "T9": False},
