...
def draw_topic_screen(screen, main_app, title, buttons, bg_image, bg_rect):
    ...
    while running:
        ...
        # --- Title ---
        title_font = dynamic_font(SCREEN_HEIGHT, main_app.ARABIC_FONT_PATH, main_app.ARABIC_BOLD_FONT_PATH, 0.04, bold=True)
        ...
        back_font = dynamic_font(SCREEN_HEIGHT, main_app.ARABIC_FONT_PATH, main_app.ARABIC_BOLD_FONT_PATH, 0.03, bold=True)
