...
def load_icon_image(path, size=(30, 30), fallback_color=(200, 200, 200)):
    """Load an icon image with fallback to colored circle if not found"""
    ...
    pygame.draw.circle(surf, (255, 255, 255, 180), (size[0]//2, size[1]//2), min(size)//2 - 2, 2)
    return surf
...
def run_profile_manage_screen(screen, SCREEN_WIDTH_PARAM, SCREEN_HEIGHT_PARAM, profile):
    ...
    icon_cache = {
        "lock": load_icon_image(LOCK_ICON_PATH, (30, 30), (200, 0, 0)),
        "unlock": load_icon_image(UNLOCK_ICON_PATH, (30, 30), (0, 200, 0)),
        "partial": load_icon_image(PARTIAL_ICON_PATH, (30, 30), (220, 180, 0)),
        "trophy": load_icon_image(TROPHY_ICON_PATH, (35, 35), (255, 215, 0)),
        "star": load_icon_image(STAR_ICON_PATH, (35, 35), (0, 150, 200)),
        "medal": load_icon_image(MEDAL_ICON_PATH, (35, 35), (200, 150, 0)),
        "warning": load_icon_image(WARNING_ICON_PATH, (35, 35), (200, 100, 100)),
    }
