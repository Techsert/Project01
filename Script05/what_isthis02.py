    ...
    def show_feedback(self, title, message, is_correct=True):
        ...
        def close_popup(event=None):
            ...
            try:
                ...
                pass
            self.close_feedback_and_continue(popup)

        # Bind click on the image to close immediately
        label_img.bind("<Button-1>", close_popup)

        # Auto-close popup after 1.5s if user doesn't click
        auto_close_id = popup.after(20000, close_popup)
