...
def topic_three(screen, main_app):
    ...
    topics_data = [
        ...
        ("", main_app.launch_quiz_lvl3, "hover_Lvl1_Topic1_ogg.ogg", "Q_lvl2.png", "Q3"),               # Quiz
    ]
...
def topic_four(screen, main_app):
    ...
    topics_data = [
        ...
        ("", main_app.launch_quiz_lvl4, "hover_Lvl1_Topic1_ogg.ogg", "Q_lvl2.png", "Q4"),               # Quiz
