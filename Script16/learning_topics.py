...
# ============================================================
def draw_topic_screen(screen, main_app, title, buttons, bg_image):
...
def topic_one(screen, main_app):
    SCREEN_WIDTH, SCREEN_HEIGHT = screen.get_size()
    bg_path = os.path.join(main_app.IMG_PATH, "learning_bg_1.png")
    ...
    topics = [
        ("أسماء الحُروف", main_app.launch_alphabit_name, "hover_alphabetNames.wav"),
        ("أصوات الحُروف", main_app.launch_alphabit_sound, "hover_alphabetSounds.wav"),
        ("أشكال الحُروف", main_app.launch_alphabit_sound, "hover_alphabetShaps.wav"),
    ...
    draw_topic_screen(screen, main_app, "Learning Level 1", buttons, bg_image)
...
def topic_two(screen, main_app):
    SCREEN_WIDTH, SCREEN_HEIGHT = screen.get_size()
    bg_path = os.path.join(main_app.IMG_PATH, "learning_bg_2.png")
    ...
    draw_topic_screen(screen, main_app, "Learning Level 2", buttons, bg_image)
