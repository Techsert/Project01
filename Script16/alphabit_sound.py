...
slides = [
            ...
            # Slide 13 - Shen
    {
        ...
        "images": [
            {"path": "../assets/img/alphabitSound/bg-nt.png", "delay": 0, "scale": (0.95, 0.82), "position": "center"},
            {"path": "../assets/img/alphabitSound/13shen.png", "delay": 0, "scale": (0.20, 0.40), "position": "center", "duration": 2000},
...
#            # Slide 17 - Zaa
    ...
    {
        "title": "أحسنت",
##        "narration": "../assets/sounds/alphabitSound/welldone.wav",
        "images": [
            {"path": "../assets/img/alphabitSound/bg-nt.png", "delay": 0, "scale": (0.95, 0.82), "position": "center"},
            {"path": "../assets/img/alphabitSound/coach.png", "sound": "../assets/sounds/alphabitSound/welldone.wav", "delay": 1000, "scale": (0.30, 0.40), "position": "center"}
        ]
    },
