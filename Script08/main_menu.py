...
class QuizApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Welcome to Learning World - Level One")
    ...
    def show_section_screen(self):
        ...
        button_specs = [
            ...
            (0.85, 0.36, "أشكال الحُروف", self.launch_alphabit_sound, "../assets/sounds/main/hover_alphabetShaps.wav"),
            (0.15, 0.89, "الأعداد", self.launch_alphabit_sound, "../assets/sounds/main/hover_numbers.wav"),
            (0.50, 0.89, "الألوان", self.launch_alphabit_sound, "../assets/sounds/main/hover_colours.wav"),
            (0.85, 0.89, "الكَلِمات", self.launch_alphabit_sound, "../assets/sounds/main/hover_words.wav"),
##            (0.15, 0.88, "الكَلِمات", self.launch_words_quiz, "../assets/sounds/main/hover_words.mp3"),
