...
slides = [
        ...
        # Slide 2 - Ba
    {
        ...
        "images": [
            {"path": "../assets/img/alphabitSound/bg-nt.png", "delay": 0, "scale": (0.95, 0.82), "position": "center"},
            {"path": "../assets/img/alphabitSound/02ba.png", "sound": "../assets/sounds/alphabitSound/02ba.wav", "delay": 0, "scale": (0.30, 0.40), "position": "center"}
        ]
    },
        # Slide 3 - Ta
    {
        ...
        "images": [
            {"path": "../assets/img/alphabitSound/bg-nt.png", "delay": 0, "scale": (0.95, 0.82), "position": "center"},
            {"path": "../assets/img/alphabitSound/03ta.png", "sound": "../assets/sounds/alphabitSound/03ta.wav", "delay": 0, "scale": (0.30, 0.40), "position": "center"}
        ]
    },
        # Slide 4 - Tha
    {
        ...
        "images": [
            {"path": "../assets/img/alphabitSound/bg-nt.png", "delay": 0, "scale": (0.95, 0.82), "position": "center"},
            {"path": "../assets/img/alphabitSound/04tha.png", "sound": "../assets/sounds/alphabitSound/04tha.wav", "delay": 0, "scale": (0.30, 0.50), "position": "center"}
        ]
    },
            # Slide 5 - Gem
    {
